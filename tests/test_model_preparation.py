...
class TestModelPreparation(unittest.TestCase):
    def setUp(self):
        ...
        self.X_train.to_csv(os.path.join(self.test_data_dir, "train_features.csv"), index=True)
        self.y_train.to_csv(os.path.join(self.test_data_dir, "train_target.csv"), index=True)
    ...
    def test_prepare_model(self):
        ...
        prepare_model(data_dir=self.test_data_dir, model_name="test_linear_svr_model.pkl")
